...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_AppEngine_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_AppEngine_t qt_meta_stringdata_AppEngine = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_AppEngine[] = {
...
Q_CONSTINIT const QMetaObject AppEngine::staticMetaObject = { {
    ...
    qt_meta_stringdata_AppEngine.offsetsAndSizes,
